...
class _SearchResultsScreenState extends State<SearchResultsScreen> {
  ...
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> results = widget.exclusive
        ? widget.category == 0
            ? FirebaseFirestore.instance.collection('TodaysDeals').snapshots()
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ProductTile(
                          ...
                          catId: data.docs[index]['catId'],
                          vendorPrice: data.docs[index]['vendorPrice'],
                        );
                      },
                    );
                  }),
