...
class _SavedAddressScreenState extends State<SavedAddressScreen> {
  ...
  _getDefaultID(){
     ...
     FirebaseFirestore.instance
          .collection('Addresses')
          .where('customerID', isEqualTo: FirebaseAuth.instance.currentUser!.uid).get()
        .then((value) => value.docs.forEach((element) {
          // print(element['name']);
          if(element['isDefault'] == true)
            currDefaultID = element.id;
            print(currDefaultID);
          setState(() {
          });
              // print(element['total']);
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return InkWell(
                                  ...
                                  child: AddressTile(
                                    ...
                                    existingDetials: [data.docs[index]['Address1'],data.docs[index]['Address2'],data.docs[index]['Pincode'],data.docs[index]['State'],data.docs[index]['Locality'],data.docs[index]['Landmark'],data.docs[index]['city']],
